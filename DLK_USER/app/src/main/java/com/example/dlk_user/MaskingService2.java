...
public class MaskingService2 extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Notification notification = new NotificationCompat.Builder(this, strId)
                    ...
                    .setContentText("정보유출 가능성이 높은 기능은 사용 불가능 합니다.")
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
                    .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.noti_icon)) //BitMap 이미지 요구, 여기 지워야 할수도있음
                    .setContentTitle("FLARE 작동중")
                    .setContentText("정보유출 가능성이 높은 기능은 사용 불가능 합니다.")
